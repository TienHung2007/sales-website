...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $_SESSION['avatar'] = $user['avatar'] ?? 'default-avatar.png'; // Lưu avatar vào session
...
<head>
    ...
    <title>Đăng Nhập - GOOD SMILE FIGURE</title>
...
<body>
    ...
    <header>
        ...
        <div class="header-main">
            <div class="container">
                ...
                <h1 style="color: orange; text-align:center; letter-spacing: 3px;">ĐĂNG NHẬP</h1>
        ...
        <div class="container payment-container">
            ...
            <div class="payment-grid">
                <div class="payment-form">
                    <h3 class="payment-section-title">Thông Tin Đăng Nhập</h3>
                    <?php if (isset($error)): ?>
                        <div class="notification-toast active" data-toast-login>
                            <button class="toast-close-btn" onclick="this.parentElement.classList.remove('active')">
                                <ion-icon name="close-outline"></ion-icon>
                            </button>
                            <div class="toast-banner">
                                <img src="../Asset/Images/Logo/favicon.png" alt="Icon">
                            </div>
                            <div class="toast-detail">
                                <p class="toast-message"><?php echo $error; ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    <form id="loginForm" method="POST">
                        ...
                        <button type="submit" class="payment-btn">Đăng Nhập</button>
                    </form>
    ...
    <!-- Toast thông báo -->
    <div class="notification-toast" data-toast-login>
        <button class="toast-close-btn" data-toast-close-login>
            <ion-icon name="close-outline"></ion-icon>
        </button>
        <div class="toast-banner">
            <img src="../Asset/Images/Logo/favicon.png" alt="Icon">
        ...
        <div class="toast-detail">
            <p class="toast-message" id="toastMessage"><?php echo isset($error) ? $error : 'Đăng nhập thành công!'; ?></p>
        </div>
    </div>
